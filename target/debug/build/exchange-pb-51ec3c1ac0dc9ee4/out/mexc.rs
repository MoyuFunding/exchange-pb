...
pub struct PrivateOrdersV3Api {
    ...
    #[prost(string, tag = "12")]
    pub last_deal_quantity: ::prost::alloc::string::String,
    #[prost(string, tag = "13")]
    ...
    pub state: i32,
    #[prost(string, tag = "21")]
    pub oco_id: ::prost::alloc::string::String,
    #[prost(string, tag = "22")]
    pub route_factor: ::prost::alloc::string::String,
    #[prost(string, tag = "23")]
    pub symbol_id: ::prost::alloc::string::String,
    #[prost(string, tag = "24")]
    pub market_id: ::prost::alloc::string::String,
    #[prost(string, tag = "25")]
    pub market_currency_id: ::prost::alloc::string::String,
    #[prost(string, tag = "26")]
