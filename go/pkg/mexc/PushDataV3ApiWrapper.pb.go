...
type PushDataV3ApiWrapper struct {
	...
	// *
	// 交易对ID
	SymbolId string `protobuf:"bytes,4,opt,name=symbolId,proto3" json:"symbolId,omitempty"`
	// *
	// 消息生成时间
...
const file_PushDataV3ApiWrapper_proto_rawDesc = "" +
	...
	"\x15publicAggreBookTicker\x18\xbb\x02 \x01(\v2 .mexc.PublicAggreBookTickerV3ApiH\x00R\x15publicAggreBookTicker\x12\x16\n" +
	"\x06symbol\x18\x03 \x01(\tR\x06symbol\x12\x1a\n" +
	"\bsymbolId\x18\x04 \x01(\tR\bsymbolId\x12\x1e\n" +
	"\n" +
	"createTime\x18\x05 \x01(\x03R\n" +
	"createTime\x12\x1a\n" +
	"\bsendTime\x18\x06 \x01(\x03R\bsendTimeB\x06\n" +
	"\x04bodyBm\n" +
	"\x1ccom.mxc.push.common.protobufB\x19PushDataV3ApiWrapperProtoH\x01P\x01Z.github.com/MoyuFunding/exchange-pb/go/pkg/mexcb\x06proto3"
