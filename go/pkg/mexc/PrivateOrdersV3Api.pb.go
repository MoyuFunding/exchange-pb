...
type PrivateOrdersV3Api struct {
	...
	LastDealQuantity   string                 `protobuf:"bytes,12,opt,name=lastDealQuantity,proto3" json:"lastDealQuantity,omitempty"`
	...
	TriggerType        int32                  `protobuf:"varint,18,opt,name=triggerType,proto3" json:"triggerType,omitempty"`
	TriggerPrice       string                 `protobuf:"bytes,19,opt,name=triggerPrice,proto3" json:"triggerPrice,omitempty"`
	State              int32                  `protobuf:"varint,20,opt,name=state,proto3" json:"state,omitempty"`
	OcoId              string                 `protobuf:"bytes,21,opt,name=ocoId,proto3" json:"ocoId,omitempty"`
	RouteFactor        string                 `protobuf:"bytes,22,opt,name=routeFactor,proto3" json:"routeFactor,omitempty"`
	SymbolId           string                 `protobuf:"bytes,23,opt,name=symbolId,proto3" json:"symbolId,omitempty"`
	MarketId           string                 `protobuf:"bytes,24,opt,name=marketId,proto3" json:"marketId,omitempty"`
	MarketCurrencyId   string                 `protobuf:"bytes,25,opt,name=marketCurrencyId,proto3" json:"marketCurrencyId,omitempty"`
	CurrencyId         string                 `protobuf:"bytes,26,opt,name=currencyId,proto3" json:"currencyId,omitempty"`
...
const file_PrivateOrdersV3Api_proto_rawDesc = "" +
	"\n" +
	"\x18PrivateOrdersV3Api.proto\x12\x04mexc\"\xb8\x06\n" +
	...
	"\x10lastDealQuantity\x18\f \x01(\tR\x10lastDealQuantity\x12.\n" +
	...
	"createTime\x12\x16\n" +
	"\x06market\x18\x11 \x01(\tR\x06market\x12 \n" +
	"\vtriggerType\x18\x12 \x01(\x05R\vtriggerType\x12\"\n" +
	"\ftriggerPrice\x18\x13 \x01(\tR\ftriggerPrice\x12\x14\n" +
	"\x05state\x18\x14 \x01(\x05R\x05state\x12\x14\n" +
	"\x05ocoId\x18\x15 \x01(\tR\x05ocoId\x12 \n" +
	"\vrouteFactor\x18\x16 \x01(\tR\vrouteFactor\x12\x1a\n" +
	"\bsymbolId\x18\x17 \x01(\tR\bsymbolId\x12\x1a\n" +
	"\bmarketId\x18\x18 \x01(\tR\bmarketId\x12*\n" +
	"\x10marketCurrencyId\x18\x19 \x01(\tR\x10marketCurrencyId\x12\x1e\n" +
	"\n" +
	"currencyId\x18\x1a \x01(\tR\n" +
	"currencyIdBk\n" +
	"\x1ccom.mxc.push.common.protobufB\x17PrivateOrdersV3ApiProtoH\x01P\x01Z.github.com/MoyuFunding/exchange-pb/go/pkg/mexcb\x06proto3"
